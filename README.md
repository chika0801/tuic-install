...
```
curl -Lo /root/tuic https://github.com/EAimTY/tuic/releases/download/tuic-server-1.0.0-beta0/tuic-server-1.0.0-beta0-x86_64-unknown-linux-gnu && chmod +x /root/tuic
```
...
1. 下载Windows客户端程序[tuic-client.exe](https://github.com/EAimTY/tuic/releases/download/tuic-client-1.0.0-beta0/tuic-client-1.0.0-beta0-x86_64-pc-windows-msvc.exe)，重命名为tuic.exe，复制到v2rayN\bin\tuic文件夹。
